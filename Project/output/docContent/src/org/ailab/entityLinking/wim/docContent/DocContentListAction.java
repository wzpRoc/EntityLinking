 ...
 * 功能描述：实体名称业务逻辑
 */
public class DocContentListAction extends BaseListAction {
    private DocContentBL bl;


    public DocContentListAction() {
        this.bl = new DocContentBL();
        super.bl = this.bl;
        this.condition = new DocContentListCondition();
    }
...
//        page.setOrderBy(" nrOccur DESC");
    ...
    public void checkCondition() {
        DocContentListCondition condition = (DocContentListCondition) this.condition;
    ...
    public String getConditionString() {
        ...
        if (StringUtil.notEmpty(condition.name)) {
            sb.append(" AND id IN (SELECT docContentId from docContentName where name ");
