        ...
        <div id="dataArea">
            <table id="dataTable">
				...
				<tr>
					...
					<td class="value"><s:textfield name="dto.startPosition"/></td>
				</tr>
				<tr>
					<td class="label">结束位置:</td>
					<td class="value"><s:textfield name="dto.endPosition"/></td>
				</tr>
				<tr>
					<td class="label">实验ID:</td>
					<td class="value"><s:textfield name="dto.experimentId"/></td>
				</tr>
				<tr>
