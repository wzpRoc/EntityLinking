        ...
        <div id="dataArea">
            <table id="dataTable">
				...
				<tr>
					...
					<td class="value"><s:textfield name="dto.seq"/></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="label">tf:</td>
					<td class="value"><s:textfield name="dto.tf"/></td>
				</tr>
				<tr>
					<td class="label">idf:</td>
					<td class="value"><s:textfield name="dto.idf"/></td>
				</tr>
				<tr>
					<td class="label">tfidf:</td>
					<td class="value"><s:textfield name="dto.tfidf"/></td>
				</tr>
