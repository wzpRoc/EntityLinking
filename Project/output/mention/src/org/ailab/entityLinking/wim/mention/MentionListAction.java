 ...
 * 功能描述：指称业务逻辑
 */
public class MentionListAction extends BaseListAction {
    private MentionBL bl;


    public MentionListAction() {
        this.bl = new MentionBL();
        super.bl = this.bl;
        this.condition = new MentionListCondition();
    }
...
//        page.setOrderBy(" nrOccur DESC");
    ...
    public void checkCondition() {
        MentionListCondition condition = (MentionListCondition) this.condition;
    ...
    public String getConditionString() {
        ...
        if (StringUtil.notEmpty(condition.name)) {
            sb.append(" AND id IN (SELECT mentionId from mentionName where name ");
