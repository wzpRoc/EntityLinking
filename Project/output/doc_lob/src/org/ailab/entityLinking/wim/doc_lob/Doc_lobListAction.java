 ...
 * 功能描述：文档大对象业务逻辑
 */
public class Doc_lobListAction extends BaseListAction {
    private Doc_lobBL bl;


    public Doc_lobListAction() {
        this.bl = new Doc_lobBL();
        super.bl = this.bl;
        this.condition = new Doc_lobListCondition();
    }
...
//        page.setOrderBy(" nrOccur DESC");
    ...
    public void checkCondition() {
        Doc_lobListCondition condition = (Doc_lobListCondition) this.condition;
    ...
    public String getConditionString() {
        ...
        if (StringUtil.notEmpty(condition.name)) {
            sb.append(" AND id IN (SELECT doc_lobId from doc_lobName where name ");
