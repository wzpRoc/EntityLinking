 ...
 * 功能描述：文章业务逻辑
 */
public class ArticleListAction extends BaseListAction {
    private ArticleBL bl;


    public ArticleListAction() {
        this.bl = new ArticleBL();
        super.bl = this.bl;
...
//        page.setOrderBy(" nrOccur DESC");
    ...
    public void checkCondition() {
        ArticleListCondition condition = (ArticleListCondition) this.condition;
    ...
    public String getConditionString() {
        ...
        if (StringUtil.notEmpty(condition.name)) {
            sb.append(" AND id IN (SELECT articleId from articleName where name ");
