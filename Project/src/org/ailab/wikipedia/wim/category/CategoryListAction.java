 ...
 * 功能描述：类别业务逻辑
 */
public class CategoryListAction extends BaseListAction {
    private CategoryBL bl;


    public CategoryListAction() {
        this.bl = new CategoryBL();
        super.bl = this.bl;
        this.condition = new CategoryListCondition();
    }
...
//        page.setOrderBy(" nrOccur DESC");
    ...
    public void checkCondition() {
        CategoryListCondition condition = (CategoryListCondition) this.condition;
    ...
    public String getConditionString() {
        ...
        if (StringUtil.notEmpty(condition.name)) {
            sb.append(" AND id IN (SELECT categoryId from categoryName where name ");
