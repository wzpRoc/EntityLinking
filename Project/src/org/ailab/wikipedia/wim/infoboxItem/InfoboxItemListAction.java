 ...
 * 功能描述：信息框条目业务逻辑
 */
public class InfoboxItemListAction extends BaseListAction {
    private InfoboxItemBL bl;


    public InfoboxItemListAction() {
        this.bl = new InfoboxItemBL();
        super.bl = this.bl;
        this.condition = new InfoboxItemListCondition();
    }
...
//        page.setOrderBy(" nrOccur DESC");
    ...
    public void checkCondition() {
        InfoboxItemListCondition condition = (InfoboxItemListCondition) this.condition;
    ...
    public String getConditionString() {
        ...
        if (StringUtil.notEmpty(condition.name)) {
            sb.append(" AND id IN (SELECT infoboxItemId from infoboxItemName where name ");
