 ...
 * 功能描述：用户组成员业务逻辑
 */
public class UserGroupUserListAction extends BaseListAction {
    private UserGroupUserBL bl;


    public UserGroupUserListAction() {
        this.bl = new UserGroupUserBL();
        super.bl = this.bl;
        this.condition = new UserGroupUserListCondition();
    }
...
//        page.setOrderBy(" nrOccur DESC");
    ...
    public void checkCondition() {
        UserGroupUserListCondition condition = (UserGroupUserListCondition) this.condition;
    ...
    public String getConditionString() {
        ...
        if (StringUtil.notEmpty(condition.name)) {
            sb.append(" AND id IN (SELECT userGroupUserId from userGroupUserName where name ");
