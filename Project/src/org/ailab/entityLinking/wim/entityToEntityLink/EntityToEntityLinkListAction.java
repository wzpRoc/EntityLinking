 ...
 * 功能描述：实体到实体的链接业务逻辑
 */
public class EntityToEntityLinkListAction extends BaseListAction {
    private EntityToEntityLinkBL bl;


    public EntityToEntityLinkListAction() {
        this.bl = new EntityToEntityLinkBL();
        super.bl = this.bl;
        this.condition = new EntityToEntityLinkListCondition();
    }
...
//        page.setOrderBy(" nrOccur DESC");
    ...
    public void checkCondition() {
        EntityToEntityLinkListCondition condition = (EntityToEntityLinkListCondition) this.condition;
    ...
    public String getConditionString() {
        ...
        if (StringUtil.notEmpty(condition.name)) {
            sb.append(" AND id IN (SELECT entityToEntityLinkId from entityToEntityLinkName where name ");
