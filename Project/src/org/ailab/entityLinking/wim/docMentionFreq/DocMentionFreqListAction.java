 ...
 * 功能描述：实体名称业务逻辑
 */
public class DocMentionFreqListAction extends BaseListAction {
    private DocMentionFreqBL bl;


    public DocMentionFreqListAction() {
        this.bl = new DocMentionFreqBL();
        super.bl = this.bl;
        this.condition = new DocMentionFreqListCondition();
    }
...
//        page.setOrderBy(" nrOccur DESC");
    ...
    public void checkCondition() {
        DocMentionFreqListCondition condition = (DocMentionFreqListCondition) this.condition;
    ...
    public String getConditionString() {
        ...
        if (StringUtil.notEmpty(condition.name)) {
            sb.append(" AND id IN (SELECT docMentionFreqId from docMentionFreqName where name ");
