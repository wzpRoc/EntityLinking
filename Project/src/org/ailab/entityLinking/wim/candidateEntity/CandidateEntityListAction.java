 ...
 * 功能描述：指称的候选实体业务逻辑
 */
public class CandidateEntityListAction extends BaseListAction {
    private CandidateEntityBL bl;


    public CandidateEntityListAction() {
        this.bl = new CandidateEntityBL();
        super.bl = this.bl;
        this.condition = new CandidateEntityListCondition();
    }
...
//        page.setOrderBy(" nrOccur DESC");
    ...
    public void checkCondition() {
        CandidateEntityListCondition condition = (CandidateEntityListCondition) this.condition;
    ...
    public String getConditionString() {
        ...
        if (StringUtil.notEmpty(condition.name)) {
            sb.append(" AND id IN (SELECT candidateEntityId from candidateEntityName where name ");
