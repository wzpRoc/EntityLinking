 ...
 * 功能描述：指称的候选实体
 */
public class CandidateEntity extends BaseDTO implements Comparable, Node {
	// ID
	protected int id;
    ...
    public void setMention(Mention mention) {
        this.setDocId(mention.getDocId());
        this.setSeqInDoc(mention.getSeqInDoc());
        this.setMentionId(mention.getId());
        this.setMentionName(mention.getName());
    }

    @Override
    public int compareTo(Object o) {
        CandidateEntity obj = (CandidateEntity) o;
        if (probOfMentionToEntity > obj.probOfMentionToEntity)
            return 1;
        else if (probOfMentionToEntity < obj.probOfMentionToEntity)
            return -1;
        else
            return 0;
    }
