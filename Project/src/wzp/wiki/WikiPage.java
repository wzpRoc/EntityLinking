...
public class WikiPage {
        ...
        /**
         * Set the wzp.wiki text associated with this page.
         * This setter also introduces side effects. This is not intended for direct use. 
         * @param wtext wzp.wiki-formatted text
         */
        ...
        /**
         * Use this method to get the wzp.wiki text associated with this page.
         * Useful for custom processing the wzp.wiki text.
         * @return a string containing the wzp.wiki text.
         */
        ...
        /**
         * 
         * @return plain text stripped of all wzp.wiki formatting.
         */
