/**
            ...
            for (i=0; i<numLabels; ++i) {
                ...
                if (this.Get('chart.labels')[i]) {
                    ...
                    */
                    ...
                    // This accounts for there only being one points on the chart
                    if (!labelX) {
                        labelX = this.gutterLeft + this.Get('chart.hmargin');
                    }
    ...
    * @param color name  The color of the tickmark
    ...
    */
    ...
    /**
    * The getPoint() method - used to get the points the mouse is currently over, if any
    * 
    ...
    */
    RGraph.Line.prototype.DrawCurvyLine = function (coords, color, linewidth)
    {
        ...
        // Now calculate the halfway points
        co.beginPath();
    ...
    /**
    * When you click on the chart, this method can return the Y value at that points. It works for any points on the
    ...
    */
    RGraph.Line.prototype.Highlight = function (shape)
    {
        if (this.Get('chart.tooltips.highlight')) {
        	...
        	if(window.reShapeTooltips){
        		reShapeTooltips(shape);
    ...
    */
    RGraph.Line.prototype.positionTooltip = function (obj, x, y, tooltip, idx)
    {
        ...
        if(window.reShapeTooltips){
        	var wrapper = $('#wraper')[0] || $('#main')[0]
        	
        	if ((canvasXY[0] + coordX + width + 3) > (wrapper.offsetWidth + wrapper.offsetLeft)) {
	            tooltip.style.left = (canvasXY[0] + coordX - width - 5) + 'px';
	
	        // Default positioning - CENTERED
	        } else {
	            tooltip.style.left = (canvasXY[0] + coordX + 5) + 'px';
	        }
        }
        else {
        	// The arrow
