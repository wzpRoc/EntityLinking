    ...
    * @param integer        The center X points (optional - if not given it will be generated from the canvas width)
    ...
    */
    ...
    /**
    * Returns the day number for a particular pubdate. Eg 1st February would be 32
    * 
    * @param   object obj A pubdate object
    * @return  int        The day number of the given pubdate
    */
    ...
    */
    RGraph.number_format = function (obj, num)
    {
        ...
        var output  = '';
        var decimal = '';
        var decimal_seperator  = obj.Get('chart.scale.points') ? obj.Get('chart.scale.points') : '.';
    ...
    RGraph.DrawBars = function (obj)
    {
        ...
        */
        ...
        for (i=0; i<hbars.length; ++i) {
            ...
            // If start points is greater than max, change it to max
            if (Math.abs(hbars[i][0]) > obj.max) {
                hbars[i][0] = obj.max;
            }
            
            // If start points plus height is less than negative max, use the negative max plus the start points
