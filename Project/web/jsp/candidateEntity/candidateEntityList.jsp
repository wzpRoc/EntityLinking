            ...
            <table id="dataTable" cellSpacing="0">
                ...
                <%
                    for (Object dto : list) {
                        ...
                        int id = candidateEntity.getEntityId();

                %>
                <tr class="tbody">
                    <td style="text-align: center">
                        <input type="checkbox" value="<%=candidateEntity.getEntityId()%>" id="id1" name="checkbox_id">
                    </td>
<%--
                    <td>
                        <a href="candidateEntityDetail?dowhat=edit&id=<%=id%>">
                            candidateEntity<%=candidateEntity.getEntityId()%>
                        </a>
                    </td>
--%>
                    <td>
