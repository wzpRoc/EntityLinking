...
<div id="mainContent">
    <form name="mainForm" id="mainForm" method="get" action="mentionLinkResultList">
...
--%>
                    ...
                    <td>
                        <%=linkResult.getEntityTitle()%>
                    </td>
                    <td>
                        <%=linkResult.getMention()%>
                    </td>
                    <td>
                        <%=linkResult.getStartIdx()%>
                    </td>
                    <td>
                        <%=linkResult.getEndIdx()%>
                    </td>
                    <td>
                        <%=linkResult.getExperimentName()%>
                    </td>
                    <td>
