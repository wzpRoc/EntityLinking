...
<div id="global-nav" class="head-nav">
    <div class="backboard">
        <div class="head-nav-info" id="infoBox">
            <a href="#" data-toggle="modal" data-target="#loginModal" id="loginBut">登录</a>
            <a href="#" data-toggle="modal" data-target="#registerModal" id="registerBut">注册</a>
        </div>
        <div class="head-nav-items">
            <ul>
                <li>
                    <a href="<%=ctx%>/home" >超毅音乐True-e</a>
                </li>
                <li>
                    <a href="<%=ctx%>/home" >首页</a>
                </li>
                <li>
                    <a href="<%=ctx%>/productList">商城</a>
                </li>
                <li>
                    <a href="<%=ctx%>/orderList">我的订单</a>
                </li>
                <li>
                    <a href="<%=ctx%>/home#product" >产品</a>
                </li>
                <li class="on">
                    <a href="<%=ctx%>/musicHall">音乐</a>
                </li>
                <li>
                    <a href="<%=ctx%>/questionCatalogList" >常见问题</a>
                </li>
                <li>
                    <a href="<%=ctx%>/forum" >论坛</a>
                </li>
                <li>
                    <a href="<%=ctx%>/home#contact" >联系</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="modal fade" style="width:300px; display: none;" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="loginModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div>
                    <form id="formForLogin" class="form-horizontal" method="post" onSubmit="return login();">
                        ...
                        <p class="col-sm-offset-1"><label style="color:black; font-weight: lighter" for="chkSave" class="checkbox" contenteditable="false"><input id="chkSave" type="checkbox"                                                                                                                                                        onclick="this.value='false';if(this.checked) this.value='true'"/>
                            记住我 </label></p>
...
<script language="javascript">
    ...
    $(document).ready(function(){
        <%
            if(isLogin) {
        %>
        loginInfoStr = "<ul><li><a href='userInfo'>"+"<%=user.getNicName()%>"+"</a></li><li><a href='#' id='logoutBut' onclick='logout()'>退出</a></li><ul>";
        $('#infoBox').html(loginInfoStr);
        <%
            }
        %>
